...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className="forgot-password-page-outer">
      <div className="forgot-password-bg-image">
        <div className="forgot-password-bg-mask" />
      </div>
      <div className="forgot-password-page-inner">
        <div className="bg-image flex flex-col items-center justify-center text-white">
          <div className="header-title mb-0.5 text-center">每日发现</div>
          <div className="header-subtitle opacity-80 text-center">发现生活中的美好时刻</div>
        </div>
        <div className="px-4 mt-4">
          <h1 className="page-title mb-4 text-center">找回密码</h1>
