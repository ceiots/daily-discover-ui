...
const RegisterPage = () => {
  ...
  return (
    <div className="register-page-outer">
      <div className="register-bg-image">
        <img
          ...
          alt="banner"
        />
        <div className="register-bg-mask" />
      </div>
      <div className="register-page-inner">
        <div className="register-header relative w-full overflow-hidden">
          <h1 className="register-header-title mb-0.5 text-center">每日发现</h1>
          <p className="register-header-subtitle opacity-90 text-center">发现生活中的美好时刻</p>
        </div>
